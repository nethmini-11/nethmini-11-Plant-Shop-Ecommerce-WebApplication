...
import com.ecom.store.store.domain.Address;
...
import com.ecom.store.store.service.OrderService;
...
public class PaymentControler {
	...
	public String payment( @RequestParam(value="missingRequiredField", required=false) boolean missingRequiredField,
